...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-jgs4wco.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-jgs4wco.containers.anotherwebservice.com/
...
```
git clone git@github.com:ghunter71/container-jgs4wco.git
cd container-jgs4wco
```
...
```
docker attach container-jgs4wco
```
